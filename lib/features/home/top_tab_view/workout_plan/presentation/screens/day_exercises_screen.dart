...
class _DayExercisesScreenState extends State<DayExercisesScreen> {
  ...
  Future<void> _loadExerciseProgress() async {
    final completedExercises =
        await ExerciseProgressService.getCompletedExercises();
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<WorkoutPlanCubit, WorkoutPlanState>(
        builder: (context, state) {
          return Scaffold(
            appBar: CustomAppBar(
              title: state is WorkoutDayExercisesLoaded
                  ? "Day ${state.day.dayNumber} Exercises"
                  : "Day Exercises",
              actions: [
                Padding(
  ...
  Future<void> _loadExerciseWeight(int exerciseId) async {
    ...
    final previousWeight =
        await ExerciseProgressService.getPreviousExerciseWeight(exerciseId);
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            if (_previousExerciseWeights[exerciseId] != null &&
                _previousExerciseWeights[exerciseId]! > 0)
              Padding(
    ...
    if (state is WorkoutPlanLoading) {
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final isCompleted =
              _completedExercises[dayExercise.exerciseId] ?? false;
          final currentWeight = _exerciseWeights[dayExercise.exerciseId] ?? 0.0;
          final previousWeight =
              _previousExerciseWeights[dayExercise.exerciseId] ?? 0.0;
          ...
          final exercise = Exercise(
            ...
            description: dayExercise
                .exerciseDescription, // Use the description from DayExerciseModel
            mainImageUrl: dayExercise.exerciseImage,
            level: dayExercise
                .exerciseLevel, // Use the level from DayExerciseModel
            isFavorite: false, // Not needed for display
            createdAt: dayExercise.createdAt,
            updatedAt: dayExercise.updatedAt,
            imageUrl: dayExercise
                .exerciseGalleryImages, // Use gallery images from DayExerciseModel
          );
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    leading: dayExercise.exerciseGalleryImages.isNotEmpty
                      ? Container(
                          width: 64,
                          height: 64,
                          child: Stack(
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(dayExercise.exerciseImage),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    '+${dayExercise.exerciseGalleryImages.length}',
                      ...
                      : CircleAvatar(
                          ...
                          backgroundImage: dayExercise.exerciseImage.isNotEmpty
                              ...
                              : const AssetImage(
                                      "assets/img/placeholder-exercise.png")
                                  as ImageProvider,
                        ),
                    title: Text(
                        ...
                        children: [
                          Wrap(
                            ...
                            children: [
                              ...
                              _InfoIconText(
                                  icon: Icons.repeat,
                                  text: "${dayExercise.reps} Reps"),
                              _InfoIconText(
                                  icon: Icons.timer,
                                  text: "${dayExercise.restTime}s Rest"),
                            ],
                          ),
                          if (currentWeight > 0)
                            Padding(
                        ...
                        GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Icon(
                              ...
                              color:
                                  isCompleted ? Colors.white : Colors.grey[700],
                              size: 22,
                            ),
                          ),
                        ),
...
class _InfoIconText extends StatelessWidget {
  final IconData icon;
  final String text;
  const _InfoIconText({Key? key, required this.icon, required this.text})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Row(
